...
function OrganisasiSA() {
    ...
    const filteredData = userData.filter(
      (admin) =>
        ...
        admin.namaOrganisasi
          ?.toLowerCase()
          .includes(searchTerm.toLowerCase()) ||
        admin.alamat?.toLowerCase().includes(searchTerm.toLowerCase()) ||
        admin.nomerTelepon?.toLowerCase().includes(searchTerm.toLowerCase()) ||
        admin.emailOrganisasi?.toLowerCase().includes(searchTerm.toLowerCase())
    );
  ...
  const filteredOrganisasi = userData.filter(
    (admin) =>
      ...
      admin.namaOrganisasi?.toLowerCase().includes(searchTerm.toLowerCase()) ||
      admin.alamat?.toLowerCase().includes(searchTerm.toLowerCase()) ||
      admin.nomerTelepon?.toLowerCase().includes(searchTerm.toLowerCase()) ||
      admin.emailOrganisasi?.toLowerCase().includes(searchTerm.toLowerCase())
  );
